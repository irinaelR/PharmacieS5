            ...
            <form action="new-vente" method="post">
                ...
                <div class="mb-4">
                    ...
                    <select id="id_med_dosage" name="id_med_dosage" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        ...
                        List<MedicinesDosage> dosages = (List<MedicinesDosage>) request.getAttribute("med_dosages");
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="quantity" name="quantity" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="">
                </div>
