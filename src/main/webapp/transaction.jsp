            ...
            <table class="table-auto w-full">
                <thead>
                    <tr class="text-left font-semibold text-gray-600 uppercase">
                        ...
                        <th class="py-2 px-4">Transiciton date</th>
                        <th class="py-2 px-4">In</th>
                        <th class="py-2 px-4">Out</th>
                        <th class="py-2 px-4">Unitary price</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="border-b border-gray-200 cursor-pointer">
                        <td class="py-2 px-4">Aspirin</td>
                        <td class="py-2 px-4">20/12/20</td>
