        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="#" method="post">
                <div class="mb-4">
                    ...
                    <input type="text" value="Med_name" required id="name" name="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <select id="laboratory" name="laboratory" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="lab_id">default lab_name</option>
                ...
                <div class="mb-4">
                    ...
                    <select id="category" name="category" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="med_category_id">default med_category_name</option>
                ...
                <div class="mb-4">
                    ...
                    <input type="checkbox" id="needsNotice" name="needsNotice" class="w-50" checked>
                </div>
